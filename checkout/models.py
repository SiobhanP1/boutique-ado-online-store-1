...
class Order(models.Model, CountryField):
    ...
    user_profile = models.ForeignKey(UserProfile, on_delete=models.SET_NULL, blank=True, 
    ...
    def update_total(self):
        """Update grand total every time new line item is added, including delivery costs"""
    ...
    def save(self, *args, **kwargs):
        """Override original save method to generate order number if not already there before saving"""
...
class OrderLineItem(models.Model):
    ...
    def save(self, *args, **kwargs):
        """Override original save method to update lineitem_total before saving"""
